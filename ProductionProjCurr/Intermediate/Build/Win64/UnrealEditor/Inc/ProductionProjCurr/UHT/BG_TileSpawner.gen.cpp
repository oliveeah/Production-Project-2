...
struct Z_Construct_UClass_ABG_TileSpawner_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_chanceOfWater_MetaData[] = {
		{ "Category", "Hex setup" },
		{ "ModuleRelativePath", "BG_TileSpawner.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_chanceOfWater;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABG_TileSpawner_Statics::NewProp_chanceOfWater = { "chanceOfWater", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABG_TileSpawner, chanceOfWater), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_chanceOfWater_MetaData), NewProp_chanceOfWater_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABG_TileSpawner_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABG_TileSpawner_Statics::NewProp_chanceOfWater,
};
...
struct Z_CompiledInDeferFile_FID_Users_linda_Documents_GitHub_Production_Project_2_ProductionProjCurr_Source_ProductionProjCurr_BG_TileSpawner_h__Script_ProductionProjCurr_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABG_TileSpawner, ABG_TileSpawner::StaticClass, TEXT("ABG_TileSpawner"), &Z_Registration_Info_UClass_ABG_TileSpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABG_TileSpawner), 3902040830U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_linda_Documents_GitHub_Production_Project_2_ProductionProjCurr_Source_ProductionProjCurr_BG_TileSpawner_h__Script_ProductionProjCurr_1311170603(TEXT("/Script/ProductionProjCurr"),
